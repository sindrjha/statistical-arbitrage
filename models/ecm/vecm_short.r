...
vecm_test_predictions <- function(hubs, window_size = 5, test_size = 250, lags) {
  ...
  for (i in 1:test_size) {
    ...
    hub_forecast <- predict(vecm, newdata = pred_data, n.ahead = window_size)
...
vecm_system <- function(hub1_name, hub2_name, validation_size = 250, test_size = 250, window_size = 5, lags=NULL, verbose = TRUE, save=TRUE) {
    ...
    if (save) {
        ...
        write.csv(actuals, paste0("../../predictions/test/actuals/",hub1_name,"_", hub2_name, "_h", test_size, "_w", window_size, "_vecm_short_actuals.csv"), row.names = FALSE)
        write.csv(last_available, paste0("../../predictions/test/last_available/",hub1_name,"_", hub2_name, "_h", test_size, "_w", window_size, "_vecm_short_last_available.csv"), row.names = FALSE)
        write.csv(predictions, paste0("../../predictions/test/predictions/",hub1_name,"_", hub2_name, "_h", test_size, "_w", window_size, "_vecm_short_predictions.csv"), row.names = FALSE)
        ...
        write.csv(actuals, paste0("../../predictions/validation/actuals/",hub1_name,"_", hub2_name,"_v", validation_size, "_h", test_size, "_w", window_size, "_vecm_short_actuals.csv"), row.names = FALSE)
        write.csv(last_available, paste0("../../predictions/validation/last_available/",hub1_name,"_", hub2_name, "_v", validation_size, "_h", test_size, "_w", window_size, "_vecm_short_last_available.csv"), row.names = FALSE)
        write.csv(predictions, paste0("../../predictions/validation/predictions/",hub1_name,"_", hub2_name, "_v", validation_size, "_h", test_size, "_w", window_size, "_vecm_short_predictions.csv"), row.names = FALSE)
    }
